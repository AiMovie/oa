...
class Auth
{
    ...
    public function __construct()
    {
        ...
        $config = \think\Config::get('AUTH_CONFIG');
    ...
    public function getGroups($uid)
    {
        ...
        $user_groups = \think\Db::name($this->_config['AUTH_GROUP_ACCESS'])->alias('a')->join($this->_config['AUTH_GROUP'].' g','a.group_id=g.id')->where("a.uid=$uid AND g.status='1'")->select();
